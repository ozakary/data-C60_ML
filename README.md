...
3. Training, validation, and testing processes for the NMR-ML model using SchNet architecture. ([directory](./nmr-ml_model/))
4. Prediction of NMR magnetic shielding parameters, including the skew, span, and σ<sub>iso</sub> from the trained NMR-ML model. ([directory](./nmr-ml_prediction/))
