...
ax1.set_xlabel(r'                             $E_{\text{DFT}}$ (eV)', fontsize=18)
...
plot11_3 = ax11.hist(energy_train_true_m3*60, 10, facecolor='red', alpha=0.8, label="Train m3", edgecolor='black', linewidth=0.5)
ax11.set_xlim(-0.52*60, -0.43*60)
ax11.set_xticks([-0.5*60, -0.45*60])
...
ax2.set_xlabel(r'                             $E_{\text{DFT}}$ (eV)', fontsize=18)
ax2.set_xlim(-1.49*60, -1.33*60)
ax2.set_xticks([-1.45*60, -1.35*60])
...
ax22.set_xlim(-0.52*60, -0.43*60)
ax22.set_xticks([-0.5*60, -0.45*60])
