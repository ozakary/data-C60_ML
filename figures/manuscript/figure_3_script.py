...
fig.subplots_adjust(left=0.105, right=0.986, wspace=0.19, top=0.979, bottom=0.106, hspace=0.274)
...
# Plot the figures
plot1 = ax1.hist(energy_train_true*60, 10, facecolor='blue', alpha=0.8, label="Train m1", edgecolor='black', linewidth=0.5)
plot1_2 = ax1.hist(energy_train_true_m2*60, 10, facecolor='green', alpha=0.8, label="Train m2", edgecolor='black', linewidth=0.5)
plot1_3 = ax1.hist(energy_train_true_m3*60, 10, facecolor='red', alpha=0.8, label="Train m3", edgecolor='black', linewidth=0.5)
ax1.set_ylabel('Count', fontsize=18)
ax1.set_xlabel(r'                             $E_{\text{DFT}}$ (eV/C$_{60})$', fontsize=18)
ax1.set_xlim(-1.49*60, -1.33*60)
#ax1.set_xticks([-1.45*60, -1.35*60])
ax1.set_xticks([-90, -86, -82])
ax1.tick_params(axis='x', labelsize=18)
ax1.tick_params(axis='y', labelsize=18)

plot11 = ax11.hist(energy_train_true*60, 10, facecolor='blue', alpha=0.8, label="Train m1", edgecolor='black', linewidth=0.5)
plot11_2 = ax11.hist(energy_train_true_m2*60, 10, facecolor='green', alpha=0.8, label="Train m2", edgecolor='black', linewidth=0.5)
plot11_3 = ax11.hist(energy_train_true_m3*60, 9, facecolor='red', alpha=0.8, label="Train m3", edgecolor='black', linewidth=0.5)
ax11.set_xlim(-0.555*60, -0.395*60)
ax11.set_xticks([-30, -26])
ax11.tick_params(axis='x', labelsize=18)
ax11.tick_params(axis='y', labelsize=18)

plot2 = ax2.hist(energy_test_true*60, 10, facecolor='blue', alpha=0.8, label="Test m1", edgecolor='black', linewidth=0.5)
plot2_2 = ax2.hist(energy_test_true_m2*60, 10, facecolor='green', alpha=0.8, label="Test m2", edgecolor='black', linewidth=0.5)
plot2_3 = ax2.hist(energy_test_true_m3*60, 10, facecolor='red', alpha=0.8, label="Test m3", edgecolor='black', linewidth=0.5)
ax2.set_xlabel(r'                             $E_{\text{DFT}}$ (eV/C$_{60})$', fontsize=18)
ax2.set_xlim(-1.49*60, -1.33*60)
ax2.set_xticks([-90, -86, -82])
ax2.tick_params(axis='x', labelsize=18)
ax2.tick_params(axis='y', labelsize=18)

plot22 = ax22.hist(energy_test_true*60, 10, facecolor='blue', alpha=0.8, label="Test m1", edgecolor='black', linewidth=0.5)
plot22_2 = ax22.hist(energy_test_true_m2*60, 10, facecolor='green', alpha=0.8, label="Test m2", edgecolor='black', linewidth=0.5)
plot22_3 = ax22.hist(energy_test_true_m3*60, 10, facecolor='red', alpha=0.8, label="Test m3", edgecolor='black', linewidth=0.5)
ax22.set_xlim(-0.555*60, -0.395*60)
ax22.set_xticks([-30, -26])
ax22.tick_params(axis='x', labelsize=18)
ax22.tick_params(axis='y', labelsize=18)
ax22.legend(["DATA-1.2", "DATA-2", "DATA-3"], loc="upper right", fontsize=18)

plot3 = ax3.hist(force_train_comb_true, bins=np.arange(-7, 7 + 0.5, 0.5), alpha=0.7, facecolor='blue', edgecolor='blue', linewidth=2, histtype='step')
plot3_2 = ax3.hist(force_train_comb_true_m2, bins=np.arange(-7, 7 + 0.5, 0.5), alpha=0.7, facecolor='green', edgecolor='green', linewidth=2, histtype='step')
plot3_3 = ax3.hist(force_train_comb_true_m3, bins=np.arange(-7, 7 + 0.5, 0.5), alpha=0.7, facecolor='red', edgecolor='red', linewidth=2, histtype='step')
ax3.set_ylabel('Count', fontsize=18)
ax3.set_xlabel(r'$\vec f_{\text{DFT}}$ (eV/Å)', fontsize=18)
ax3.tick_params(axis='x', labelsize=18)
ax3.tick_params(axis='y', labelsize=18)

plot4 = ax4.hist(force_test_comb_true, bins=np.arange(-7, 7 + 0.5, 0.5), facecolor='blue', alpha=0.7, edgecolor='blue', linewidth=2, histtype='step')
plot4_2 = ax4.hist(force_test_comb_true_m2, bins=np.arange(-7, 7 + 0.5, 0.5), facecolor='green', alpha=0.7, edgecolor='green', linewidth=2, histtype='step')
plot4_3 = ax4.hist(force_test_comb_true_m3, bins=np.arange(-7, 7 + 0.5, 0.5), facecolor='red', alpha=0.7, edgecolor='red', linewidth=2, histtype='step')
ax4.set_xlabel(r'$\vec f_{\text{DFT}}$ (eV/Å)', fontsize=18)
