...
ax1.set_xlabel('DFT energy (eV)', fontsize=13)
ax1.set_ylabel('NEP energy (eV)', fontsize=13, x=-2.0)
ax1.set_xticks([-1.48*60, -1.46*60, -1.44*60])
ax1.set_yticks([-1.48*60, -1.46*60, -1.44*60])
ax1.text(.04, .91, 'Train RMSE = 11.4 meV', fontsize=12, transform=ax1.transAxes)
ax1.text(.04, .83, 'Test RMSE = 11.4 meV', fontsize=12, transform=ax1.transAxes)
ax1.text(.04, .75, f'Test R$^2$ = {r_value_e_test_m1**2:.3f}', fontsize=12, transform=ax1.transAxes)
...
ax2.set_xlabel('DFT energy (eV)', fontsize=13)
ax2.set_xticks([-1.39*60, -1.37*60, -1.35*60])
ax2.set_yticks([-1.39*60, -1.37*60, -1.35*60])
ax2.text(.04, .91, 'Test RMSE = 12.0 meV', fontsize=12, transform=ax2.transAxes)
ax2.text(.04, .83, 'Test RMSE = 12.0 meV', fontsize=12, transform=ax2.transAxes)
ax2.text(.04, .75, f'Train R$^2$ = {r_value_e_test_m2**2:.3f}', fontsize=12, transform=ax2.transAxes)
...
ax3.set_xlabel('DFT energy (eV)', fontsize=13)
ax3.set_xticks([-0.5*60, -0.48*60, -0.46*60, -0.44*60])
ax3.set_yticks([-0.5*60, -0.48*60, -0.46*60, -0.44*60])
ax3.text(.04, .91, 'Train RMSE = 10.8 meV', fontsize=12, transform=ax3.transAxes)
ax3.text(.04, .83, 'Test RMSE = 13.2 meV', fontsize=12, transform=ax3.transAxes)
ax3.text(.04, .75, f'Test R$^2$ = {r_value_e_test_m3**2:.3f}', fontsize=12, transform=ax3.transAxes)
...
ax4.text(0.05, 0.83, 'Test RMSE = 0.0435 eV/Å', fontsize=12, transform=ax4.transAxes)
ax4.text(0.05, 0.75, f'Test R$^2$ = {r_value_f_test_m1**2:.3f}', fontsize=12, transform=ax4.transAxes)
...
ax5.text(0.05, 0.82, 'Test RMSE = 0.0448 eV/Å', fontsize=12, transform=ax5.transAxes)
...
ax6.text(0.05, 0.82, 'Test RMSE = 0.0463 eV/Å', fontsize=12, transform=ax6.transAxes)
