...
ax1.set_xlabel(r'                             $E_{DFT}$ (eV/atom)', fontsize=18)
...
ax2.set_xlabel(r'                             $E_{DFT}$ (eV/atom)', fontsize=18)
...
ax3.set_xlabel(r'$\vec f_{DFT}$ (eV/Å)', fontsize=18)
...
ax4.set_xlabel(r'$\vec f_{DFT}$ (eV/Å)', fontsize=18)
