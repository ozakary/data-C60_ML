...
ax.set_ylabel('$\\sigma_{iso}$ (ppm)', fontsize=16)
ax.set_xlabel('T (K)', fontsize=16)
ax.tick_params(axis='x', labelsize=16)
ax.tick_params(axis='y', labelsize=16)
handles, labels = ax.get_legend_handles_labels()
ax.legend([single, hh, hp], ["$_{ }^{13}\\text{C}_{1}$" + f'     : R$^2$ = {linreg_params_s.rvalue**2:.4f}', "$_{ }^{13}\\text{C}_{2,\\text{HH}}$" + f' : R$^2$ = {linreg_params_hh.rvalue**2:.4f}', "$_{ }^{13}\\text{C}_{2,\\text{HP}}$" + f' : R$^2$ = {linreg_params_hp.rvalue**2:.4f}'], loc="lower left", fontsize=16)
ax.grid(True)
