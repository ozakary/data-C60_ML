...
print("\n")
print('260K C1: avg sigma iso = ' + str(mean_single[0]) + ' and std = ' + str(dev_single[0]) + ' and SEM: ' + str(sem_single[0]) + " data: " + str(len(sig_single[0])))
print('280K C1: avg sigma iso = ' + str(mean_single[1]) + ' and std = ' + str(dev_single[1]) + ' and SEM: ' + str(sem_single[1]) + " data: " + str(len(sig_single[1])))
print('300K C1: avg sigma iso = ' + str(mean_single[2]) + ' and std = ' + str(dev_single[2]) + ' and SEM: ' + str(sem_single[2]) + " data: " + str(len(sig_single[2])))
print('320K C1: avg sigma iso = ' + str(mean_single[3]) + ' and std = ' + str(dev_single[3]) + ' and SEM: ' + str(sem_single[3]) + " data: " + str(len(sig_single[3])))
print('340K C1: avg sigma iso = ' + str(mean_single[4]) + ' and std = ' + str(dev_single[4]) + ' and SEM: ' + str(sem_single[4]) + " data: " + str(len(sig_single[4])))
print("\n")
...
print("Lin fit of C1: " + str(np.round(linreg_params_s.slope, 6)) + "T" + " + " + str(np.round(linreg_params_s.intercept, 6)))
print(f'C1 slope gradient std error: {linreg_params_s.stderr*1000:.4f} ppb \n')
print(f'C1 slope intercept std error: {linreg_params_s.intercept_stderr*1000:.4f} ppb \n')
...
print(f'Grad(C1) - Grad(hh) =  {(linreg_params_s.slope - linreg_params_hh.slope)*1000:.4f} ppb +- {(linreg_params_s.stderr**2+linreg_params_s.stderr**2)**(1/2)*1000:.4f} ppb')
print(f'Grad(C1) - Grad(hp) =  {(linreg_params_s.slope - linreg_params_hp.slope)*1000:.4f} ppb +- {(linreg_params_s.stderr**2+linreg_params_s.stderr**2)**(1/2)*1000:.4f} ppb')
...
ax.legend([single, hh, hp], ["$_{ }^{13}\\text{C}_{1}$" + f'   : R$^2$ = {linreg_params_s.rvalue**2:.3f}', "$_{ }^{13}\\text{C}^{\\text{HH}}_{2}$" + f' : R$^2$ = {linreg_params_hh.rvalue**2:.3f}', "$_{ }^{13}\\text{C}^{\\text{HP}}_{2}$" + f' : R$^2$ = {linreg_params_hp.rvalue**2:.3f}'], loc="lower left", fontsize=16)
ax.grid(True)
