...
def ld(f, s):
    try:
        return np.concatenate(np.loadtxt('./' + f + '/volumes_ell_average.txt')[0::s], axis=None)
...
# Load the data
volumes_1bead = [ld('100K/100K_1b', 1), ld('150K/150K_1b', 1), ld('200K/200K_1b', 1), ld('250K/250K_1b', 1), 
                ld('300K/300K_1b', 1), ld('350K/350K_1b', 1), ld('400K/400K_1b', 1), ld('500K/500K_1b', 1)]

volumes_2bead = [ld('100K/100K_2b', 1), ld('150K/150K_2b', 1), ld('200K/200K_2b', 1), ld('250K/250K_2b', 1), 
                ld('300K/300K_2b', 1), ld('350K/350K_2b', 1), ld('400K/400K_2b', 1), ld('500K/500K_2b', 1)]


volumes_4bead = [ld('100K/100K_4b', 1), ld('150K/150K_4b', 1), ld('200K/200K_4b', 1), ld('250K/250K_4b', 1), 
                ld('300K/300K_4b', 1), ld('350K/350K_4b', 1), ld('400K/400K_4b', 1), ld('500K/500K_4b', 1)]


volumes_8bead = [ld('100K/100K_8b', 2), ld('150K/150K_8b', 2), ld('200K/200K_8b', 2), ld('250K/250K_8b', 2), 
                ld('300K/300K_8b', 2), ld('350K/350K_8b', 2), ld('400K/400K_8b', 2), ld('500K/500K_8b', 2)]


volumes_16bead = [ld('100K/100K_16b', 3), ld('150K/150K_16b', 3), ld('200K/200K_16b', 3), ld('250K/250K_16b', 3), 
                ld('300K/300K_16b', 3), ld('350K/350K_16b', 3), ld('400K/400K_16b', 3), ld('500K/500K_16b', 3)]


volumes_32bead = [ld('100K/100K_32b', 3), ld('150K/150K_32b', 3), ld('200K/200K_32b', 3), ld('250K/250K_32b', 3), 
                ld('300K/300K_32b', 3), ld('350K/350K_32b', 3), ld('400K/400K_32b', 2), ld('500K/500K_32b', 2)]


volumes_64bead = [ld('100K/100K_64b', 2), ld('150K/150K_64b', 2), ld('200K/200K_64b', 2), ld('250K/250K_64b', 1), 
                ld('300K/300K_64b', 1), ld('350K/350K_64b', 2), ld('400K/400K_64b', 2), ld('500K/500K_64b', 2)]


volumes_128bead = [ld('100K/100K_128b', 2), ld('150K/150K_128b', 2)]
...
ax.scatter(temps, vol_64bead, color='#520202', alpha=0.65, s=22)
err7 = ax.errorbar(temps, vol_64bead, label="P=64", yerr=sem_64bead, capsize=2.0, fmt="o", color='#520202', markersize=6, marker="p", linestyle=(0, (3, 1, 1, 1)))
ax.scatter(temps[0:2], vol_128bead, color='orange', alpha=0.65, s=22)
err8 = ax.errorbar(temps[0:2], vol_128bead, label="P=128", yerr=sem_128bead, capsize=2.0, fmt="o", color='orange', markersize=6, marker="x", linestyle=(0, (3, 1, 1, 1, 1, 1)))
...
axins2.scatter(temps, vol_64bead, color='#520202', alpha=0.65, s=22)
err7 = axins2.errorbar(temps, vol_64bead, label="P=64", yerr=sem_64bead, capsize=2.0, fmt="o", color='#520202', markersize=6, marker="p", linestyle=(0, (3, 1, 1, 1)))
axins2.scatter(temps[0:2], vol_128bead, color='orange', alpha=0.65, s=22)
err8 = axins2.errorbar(temps[0:2], vol_128bead, label="P=128", yerr=sem_128bead, capsize=2.0, fmt="o", color='orange', markersize=6, marker="x", linestyle=(0, (3, 1, 1, 1, 1, 1)))
