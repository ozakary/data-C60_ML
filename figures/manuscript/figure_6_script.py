...
def ld(f):
    try:
        return np.concatenate(np.loadtxt('./' + f + '/volumes_ell_average.txt'), axis=None)
...
volumes_128bead = [ld('100K/100K_128b'), ld('150K/150K_128b'), ld('200K/200K_128b'), ld('250K/250K_128b'), ld('300K/300K_128b')]
...
ax.scatter(temps[0:5], vol_128bead, color='orange', alpha=0.65, s=22)
err8 = ax.errorbar(temps[0:5], vol_128bead, label="P=128", yerr=sem_128bead, capsize=2.0, fmt="o", color='orange', markersize=6, marker="x", linestyle=(0, (3, 1, 1, 1, 1, 1)))
ax.set_xlabel('Temperature (K)', fontsize=14)
ax.set_ylabel('Volume (Å$^{3}$)', fontsize=14)
ax.set_ylim(182.25, 184.75)
ax.tick_params(axis='x', labelsize=14)
ax.tick_params(axis='y', labelsize=14)
ax.legend(handles=[err8, err7, err6, err5, err4, err3, err2], loc="upper center", fontsize=14, ncols=4, bbox_to_anchor=(0.5, 1.2), framealpha=1)
ax.grid(True)
...
axins2.scatter(temps[0:5], vol_128bead, color='orange', alpha=0.65, s=22)
err8 = axins2.errorbar(temps[0:5], vol_128bead, label="P=128", yerr=sem_128bead, capsize=2.0, fmt="o", color='orange', markersize=6, marker="x", linestyle=(0, (3, 1, 1, 1, 1, 1)))
