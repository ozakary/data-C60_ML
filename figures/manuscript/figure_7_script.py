...
ax1.set_xlabel(r'$T$ (K)', fontsize=13)
ax1.set_ylabel(r'$\langle V_{\text{eff}} \rangle$ [T] ($Å^3$)', fontsize=13)
...
err1 = ax2.errorbar(temps, m1_data_abs_diff, yerr=m1_data_sem, capsize=2.0, marker="o", markersize=7, color='black', label='MLIP-1.2.2', linestyle="solid")
ax2.set_xlabel(r'$T$ (K)', fontsize=13)
ax2.set_ylabel(r'$\langle V_{\text{eff}} \rangle$ [T] - $\langle V_{\text{eff}} \rangle$ [150 K] ($Å^3$)', fontsize=13)
