...
ax1.set_xlabel(r'$E_{\text{DFT}}$ (eV/C$_{60}$)', fontsize=13)
ax1.set_ylabel(r'$E_{\text{ML}}$ (eV/C$_{60}$)', fontsize=13, x=-2.0)
...
ax2.set_xlabel(r'$E_{\text{DFT}}$ (eV/C$_{60}$)', fontsize=13)
...
ax3.set_xlabel(r'$E_{\text{DFT}}$ (eV/C$_{60}$)', fontsize=13)
