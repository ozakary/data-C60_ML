...
ax1.text(.04, .83, 'valid. RMSE = 11.4 meV', fontsize=12, transform=ax1.transAxes)
...
ax2.text(.04, .91, 'train. RMSE = 12.0 meV', fontsize=12, transform=ax2.transAxes)
ax2.text(.04, .83, 'valid. RMSE = 12.0 meV', fontsize=12, transform=ax2.transAxes)
...
ax3.text(.04, .83, 'valid. RMSE = 13.2 meV', fontsize=12, transform=ax3.transAxes)
