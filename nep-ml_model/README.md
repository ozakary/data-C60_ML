...
Here we have only provided truncated `train.xyz` and `test.xyz` files as an example. The actual files used to train the models **MLIP-1**, **MLIP-2**, and **MLIP-3** can be found [here](../dft_calculations_nep).
